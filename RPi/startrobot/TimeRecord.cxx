...
CTimeRecord::CTimeRecord(string a_Name, int a_MinOffset) : CRecord(a_Name)
  {
  m_MinOffset = a_MinOffset;
  }

std::list<string> CTimeRecord::TitlesForTime(CTimeVal a_Time)
  {
...
float CTimeRecord::DurationForTime(CTimeVal a_Time)
  {
...
std::list<CSlot> CTimeRecord::RecordsForTime(CTimeVal a_Time)
  {
  std::list<string> list = TitlesForTime(a_Time);
